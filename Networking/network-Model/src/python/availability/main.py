...
if __name__ == "__main__":
    ...
    print("first point: ", count_probability(model, 100))
    print("1000", count_probability(model, 1000))
    print("10000", count_probability(model, 10000))
    draw_graph(model)

    model.add_edge(1, 20)
    model[1][20]['weight'] = 0.95
    print("second point: ", count_probability(model, 100))
    print("1000", count_probability(model, 1000))
    print("10000", count_probability(model, 10000))
    draw_graph(model)
    ...
    print("third point: ", count_probability(model, 100))
    print("1000", count_probability(model, 1000))
    print("10000", count_probability(model, 10000))
    draw_graph(model)
    ...
    print(r)
    print("fourth 100: ", count_probability(model, 100))
    print("1000", count_probability(model, 1000))
    print("10000", count_probability(model, 10000))
    draw_graph(model)
